...
ware the building can stock (default 6); `useOneWareEach=true` means one of *each* listed
...
wait2_length; }` — all three lengths in GF. **tool** = the tool ware needed to *recruit*
